...
class ClientSpec extends ObjectBehavior
{
    ...
    function it_creates_request_data_shipment(
        ...
        $shippingGateway->getConfigValue('login')->willReturn('login');
        $shippingGateway->getConfigValue('password')->willReturn('password');
    ...
    {
        $this->shouldThrow(new InvalidArgumentException('$shippingGateway must be set before initialization.'))->during('createExpedition');
    }
    ...
    function it_should_not_allow_create_expedition_without_shipment(ShippingGatewayInterface $shippingGateway): void
    {
        ...
        $shippingGateway->getConfigValue('password')->willReturn('password');
        $this->setShippingGateway($shippingGateway);
        $this->shouldThrow(new InvalidArgumentException('$shipment must be set before initialization.'))->during('createExpedition');
    }
